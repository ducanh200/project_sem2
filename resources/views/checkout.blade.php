                            ...
                            <div class="cart-detail p-3 p-md-4">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <div class="radio">
                                            <label for="COD">
                                                <input name="payment_method" type="radio" id="payment" value="VN PAY">
                                ...
                                <button style="background-color: #2ca02c;border: #2ca02c solid 0" type="submit" class="site-btn">PLACE ORDER</button>
                            </div>
                        </div>
                    </div>
                </div>
